...
#ifndef _ORBPF__LINUX_FILTER_H__
#define _ORBPF__LINUX_FILTER_H__

#include <linux/orbpf_conf.h>

#ifdef ORBPF_CONF_LINUX_STDARG_H
...
#define BPF_CAST_CALL(x)					\
		((u64 (*)(u64, u64, u64, u64, u64))(void *)(x))
...
struct bpf_prog {
	...
	char			prog_label[ORBPF_PROG_LABEL_LEN + 1];
	u32			prog_label_len;
...
static inline void bpf_jit_dump(unsigned int flen, unsigned int proglen,
				u32 pass, void *image)
{
	printk("flen=%u proglen=%u pass=%u image=%lx from=%s pid=%d\n", flen,
	       proglen, pass, (long)image, current->comm, task_pid_nr(current));
